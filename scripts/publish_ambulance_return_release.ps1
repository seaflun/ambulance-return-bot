...
gh release create $tag $stagedVersionPath $stagedZipPath $stagedShaPath $stagedUpdaterPath --repo $Repository --title $tag --notes "SinpoSmart - 救護Worker 公務電腦使用包 $Version"
